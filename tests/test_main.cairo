...
@external
func test_owner_of{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(arguments):
    alloc_locals
...
@external
func test_lookup{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(arguments):
    alloc_locals
