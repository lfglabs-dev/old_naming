...
func test_basic_resolver{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    Naming.buy(
        naming_contract, token_id, th0rgal_string, days=365, resolver=basic_resolver, address=456
    );
...
func test_simple_resolver{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    Naming.buy(naming_contract, token_id, 'alpha', days=365, resolver=simple_resolver, address=456);
